		...
		<div class="main-container">
			<div class="padding-md">
				<h2 class="header-text">
					学员注册 <span class="sub-header"> student reg </span>
				</h2>
				<div class="smart-widget m-top-lg widget-dark-blue">
					<div class="smart-widget-header">
						新学员登记 <span class="smart-widget-option"> <span
					...
					<div class="smart-widget-inner">
						...
						<div class="smart-widget-body">
							<form action="student_register?username=${param.username}&userToken=${param.userToken}" method="post">
								<div class="form-group">
									<label for="exampleInputEmail1">学生id</label> <input type="text"
										class="form-control" id="exampleInputPassword1"
										placeholder="id" name="student.id">
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">学生姓名</label> <input type="text"
										class="form-control" id="exampleInputPassword1"
										placeholder="name" name="student.name">
								</div>
								<!-- /form-group -->
