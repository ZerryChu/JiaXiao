				...
				<div class="inbox-body padding-md">
					<div class="row m-bottom-md">
						...
						<div class="col-sm-6 text-right text-left-sm">
							...
							<a href="#" class="btn btn-danger">清除记录</a>
						</div>
						<!-- ./col -->
					</div>
					<!-- .row -->
					...
					<div style="min-height: 500px;"
						class="message-table table-responsive">
						<table id="msg_table" class="table table-bordereds">
							<thead>
								<tr>
									...
									.each(
											...
											function() {
												...
												while (data.returndata[i] != undefined) {
													var index = i + 1;
													str += "<tr><td class=\"text-center\"><div class=\"custom-checkbox\"><input type=\"checkbox\" id=\"chk" + index + "\" class=\"inbox-check\" value=\"" + data.returndata[i].id + "\"><label for=\"chk" + index + "\"></label></div></td><td><a href=\"#\"><i class=\"";
													if (1 == data.returndata[i].solved)
														str += "fa fa-star fa-lg text-warning\"";
													else
														str += "fa fa-star-o fa-lg\"";
													str += "></i></a></td><td><div class=\"author-avatar\"><img src=\"images/"
						    + data.returndata[i].stu_name // pic
						    + ".jpg\" onerror=\"javascript:this.src='images/icon.gif'\"></div><div class=\"author-name\"><a href=\"#\"><strong class=\"block font-md\">"
															+ data.returndata[i].stu_name
															+ "</strong></a> <a href=\"#\" class=\"text-muted\">"
															+ data.returndata[i].state
															+ "</a></div></td><td><a href=\"#\"> "
